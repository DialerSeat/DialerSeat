...
export const LAND: ReadonlyArray<{ name: string; ring: LatLon[] }> = [
  {
    // Traced anticlockwise from Point Barrow: the Arctic rim, down through
    // Hudson Bay and the Labrador coast, the whole Atlantic seaboard, round
    // the Gulf and Central America, then back up the Pacific through Baja and
    // the Alaska peninsula. ~110 points where the first pass had 59, because
    // this is the landmass every ping on the map sits on and it was the one
    // most obviously wrong — the Gulf of California was missing entirely, so
    // Baja was fused to the mainland, and Florida was a stub.
    name: 'North America',
    ring: [
      [71.4, -156.5], [70.3, -148.3], [69.7, -141], [69.4, -134], [70.6, -128],
      [69.5, -120], [68, -113], [68, -104], [67.8, -95], [68, -87], [66.5, -86],
      [63.3, -90.7], [58.8, -94.2], [57, -92.3], [55, -82.3], [52, -81.5],
      [51.2, -79.5], [52, -78.5], [55, -77], [60, -78], [62.4, -78], [61.5, -71],
      [59, -68], [60.4, -64.5], [57, -61.5], [54.2, -57.5], [51.9, -55.4],
      [49.2, -64], [48, -65.5], [47, -65], [46, -63.5], [45.6, -61],
      [44.6, -63.6], [43.5, -65.9], [45.2, -66.1], [44.8, -67], [43.7, -70.2],
      [42, -70], [41.6, -69.9], [41.4, -71.4], [40.9, -72], [40.6, -73.8],
      [40.5, -74.2], [39.4, -74.4], [38.8, -75.1], [37, -76], [35.2, -75.5],
      [33.8, -78], [32.8, -79.9], [32, -80.8], [30.4, -81.4], [28.4, -80.6],
      [25.8, -80.1], [24.5, -81.8], [26.1, -81.8], [27.8, -82.6], [29.7, -85],
      [30.2, -88], [29, -89.2], [29.3, -94.8], [27.8, -97.4], [25.9, -97.2],
      [22.2, -97.8], [19.2, -96.1], [18.1, -94.4], [19.8, -90.5], [21.6, -88],
      [21.5, -87], [21.2, -86.8], [17.5, -88.2], [15.8, -85.8], [13, -83.5],
      [10, -83], [9.4, -79.5], [8.9, -77.7], [8, -78.2], [7.5, -80],
      [9.5, -85], [11.5, -86.5], [13.2, -88.5], [14, -91.5], [16.2, -95.2],
      [16.8, -99.9], [19, -104.3], [20.6, -105.3], [23.2, -106.4], [27, -110.9],
      [27.9, -110.9], [31.8, -114.8], [30, -114.5], [26, -111.3], [24, -110.3],
      [22.9, -109.9], [24.8, -112.2], [28, -114.3], [30.5, -116], [32.5, -117.1],
      [33.7, -118.2], [34.5, -120.5], [36.6, -121.9], [37.8, -122.5],
      [40.4, -124.4], [43, -124.4], [46.2, -124], [48.4, -124.7], [50, -127.5],
      [54.3, -130.3], [56, -134], [59.5, -139.7], [60.5, -147], [59, -152],
      [56, -158], [55, -162], [58.7, -158], [60, -162], [62.5, -165],
      [64.5, -161], [65.5, -167], [66.9, -162], [68.3, -166.8], [70.6, -160],
      [71.4, -156.5],
    ],
  },
  {
