...
export const COMPETITOR_FEATURES: Record<string, CompetitorFeatures> = {
  ...
  "batchdialer": {
    lede: "BatchDialer lives inside the BatchLeads / PropStream ecosystem &mdash; real estate investors and wholesalers pulling skip-traced property lists and dialing them. If that is your business, their data pipeline is genuinely convenient and this page will not talk you out of it.",
    rows: [
  ...
  "orum": {
    lede: "Credit where due: Orum&apos;s AI-driven parallel dialing \u2014 up to 5&ndash;10 lines at once \u2014 is a real, effective way to increase raw call volume for teams that can afford it. But it comes at a reported $250 to $800 per user per month, annual billing only, a 3-seat minimum, and pricing you can only get by requesting a demo. Reviewers also consistently flag a 1&ndash;2 second connection lag when a parallel-dialed call bridges to a rep, and numbers getting flagged &ldquo;Spam Likely&rdquo; over time. DialerSeat\u2122 is self-serve, published pricing, one seat minimum, and every dialer mode included from day one.",
    rows: [
