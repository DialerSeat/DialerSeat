...
// Where "continue" goes: billing, carrying the invite. Billing applies it,
// and for an owner-pays code that means redeeming it, showing the seat as
// covered and going to the dialer rather than collecting anything.
