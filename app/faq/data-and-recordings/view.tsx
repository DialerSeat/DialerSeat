    ...
    <>
      ...
      >
        <style>{`
          ...
          .drc-warn {
            margin: 28px 0; padding: 24px 26px; background: ${T.surface};
          ...
          .drc-cta-box p { font-size: 15px; color: ${T.muted}; line-height: 1.6; margin: 0 0 28px 0; }
        ...
        <article className="drc-root">
          ...
          <div className="drc-cta-box">
            ...
            <a href={isSignedIn ? '/dashboard/settings' : '/sign-up'} className="drc-cta-btn">
              {isSignedIn ? 'GO TO SETTINGS →' : 'START 7 DAYS FREE →'}
            </a>
          </div>
        </article>
      </div>
